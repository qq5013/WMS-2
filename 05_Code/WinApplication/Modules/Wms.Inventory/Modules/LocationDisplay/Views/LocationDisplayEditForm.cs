...
{
    public partial class LocationDisplayEditForm : Framework.UI.Template.Single.SingleEditForm
    {
        public LocationDisplayEditForm()
        {
            InitializeComponent();
        }
        ...
        public override bool CreateData()
        {
            try
            {
                ...
                CurrentData = ServiceHelper.WarehouseService.GetLocation(newId);
