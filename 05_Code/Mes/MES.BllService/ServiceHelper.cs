...
namespace MES.BllService
{
    ...
    public static class ServiceHelper
    {
        ...
        ///     数据库连接工厂
        /// </summary>
        public static readonly HttpConnectionFactory Connection = new HttpConnectionFactory
            {
                Name = "MES"
            };
        ...
        ///     日志
        /// </summary>
        private static readonly ILogger FileWriter = new FileWriter
            {}
                                        ;
        ...
        order by d.[name]";
                                ...
                                ConfigurationManager.ConnectionStrings["MES"].ConnectionString))
                    {
                        ...
                        _tableInfos = db2O.Query(sqlCommand);
                        sc.Close();
                    }
                }
                return _tableInfos;
