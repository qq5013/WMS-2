...
namespace MES.Common
{
    ...
    public static partial class CommonApi
    {
        ...
        private static readonly object[] EmptyTypes = new object[0];
        ...
        /// <param name="e"></param>
        public static void SelectUser_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
...
//如果有设置单据号方法传入，则调用
        ...
        public static void BindVendor(this LookUpEdit gridLookUpEdit, ControlMode controlMode)
        {
            ...
            //gridLookUpEdit.Properties.Columns.AddRange(new[]
            //    {
            //        new GridColumn
            //            {
            //                FieldName = "Name",
            ...
            {
                gridLookUpEdit.BindClearButtton();
            }
        ...
        public static void BindProcess(this GridLookUpEdit gridLookUpEdit, ControlMode controlMode, int productStationId)
        {
            ...
            {
                BindClearButtton(gridLookUpEdit);
            }
        ...
        private static void BindClearButtton(this ButtonEdit buttonEdit)
        {
            for (int index = 0; index < buttonEdit.Properties.Buttons.Count; index++)
            {
                EditorButton button = buttonEdit.Properties.Buttons[index];
                if (button.Kind == ButtonPredefines.Delete)
                {
                    buttonEdit.Properties.Buttons.RemoveAt(index);
                    break;
                }
            }
            buttonEdit.Properties.Buttons.Add(new EditorButton(ButtonPredefines.Delete));
            buttonEdit.Properties.ButtonClick += (sender, e) =>
                {
                    // 定义删除按钮功能，清空控件数据
        ...
        /// </summary>
        /// <param name="repositoryItemGridLookUpEdit"></param>
        public static RepositoryItemGridLookUpEdit BindDeliveryAddress(
            this RepositoryItemGridLookUpEdit repositoryItemGridLookUpEdit)
        {
            repositoryItemGridLookUpEdit.DisplayMember = "Name";
            ...
            return repositoryItemGridLookUpEdit;
        }
        ...
        {
            gridLookUpEdit.Properties.NullText = controlMode == ControlMode.Query ? Resources.all : Resources.plsSelect;
            BindDeliveryAddress(gridLookUpEdit.Properties);
            gridLookUpEdit.BindClearButtton();
        }
        ...
        /// </summary>
        /// <param name="repositoryItemLookUpEdit"></param>
        public static RepositoryItemLookUpEdit BindProductionOrderType(
            this RepositoryItemLookUpEdit repositoryItemLookUpEdit)
        {
            repositoryItemLookUpEdit.DisplayMember = "Name";
            ...
            repositoryItemLookUpEdit.Columns.AddRange(new[]
                {
                    ...
                    new LookUpColumnInfo {FieldName = "Description", Caption = Resources.description}
                });

            repositoryItemLookUpEdit.DataSource = ServiceBloker.GetEnumQuery("ProductionOrderType");
        ...
        /// </summary>
        /// <param name="gridLookUpEdit"></param>
        public static LookUpEdit BindProductionOrderType(this LookUpEdit gridLookUpEdit)
        {
            BindProductionOrderType(gridLookUpEdit.Properties);
        ...
        public static void BindProductCategory(this RepositoryItemGridLookUpEdit lookUpEdit)
        {
            lookUpEdit.DisplayMember = "Name";
            lookUpEdit.ValueMember = "ProductCategoryId";
            lookUpEdit.NullText = "";
            lookUpEdit.View.Columns.AddRange(new[]
                {
                    new GridColumn
                        {
                            FieldName = "Name",
            ...
            lookUpEdit.DataSource = ServiceBloker.GetService<ProductCategory>().GetAll(new QueryInfo());
        }
        ...
        /// </summary>
        /// <param name="lookUpEdit"></param>
        public static void BindWarehouse(this RepositoryItemGridLookUpEdit lookUpEdit)
        {
            lookUpEdit.DisplayMember = "Name";
            lookUpEdit.ValueMember = "WarehouseId";
            lookUpEdit.NullText = "";
            lookUpEdit.View.Columns.AddRange(new[]
                {
                    new GridColumn
            ...
            lookUpEdit.DataSource = ServiceBloker.GetService<Warehouse>().GetAll(new QueryInfo());
        }
        ...
        public static void FillData(this IBaseEntity entity, Control.ControlCollection controls)
        {
            ...
            foreach (object control in controls)
            {
                if (control is GridLookUpEdit)
                {
                    ...
                    {
                        object o = propertyInfo.GetValue(entity, EmptyTypes);
                        // 控件取值不为空
                        if (o != null)
                        {
                ...
                if (control is GridLookUpEdit)
                {
                    ...
                    if (propertyInfo != null && propertyInfo.CanWrite)
                    {
                        if (gridLookUpEdit.EditValue != null && !propertyInfo.PropertyType.IsEnum)
                            ...
                            propertyInfo.SetValue(entity, gridLookUpEdit.EditValue, EmptyTypes);
                    }
                }
                if (control is LookUpEdit)
                {
                    ...
                    if (propertyInfo != null)
                    {
                        propertyInfo.SetValue(entity, lookUpEdit.EditValue, EmptyTypes);
                    }
                }
                if (control is DateEdit)
                {
                    ...
                    if (propertyInfo != null)
                    {
                        ...
                        propertyInfo.SetValue(entity, dateEdit.EditValue ?? DateTimeHelper.Min, EmptyTypes);
                    }
                }
                else if (control is CheckEdit)
                {
                    ...
                    if (propertyInfo != null)
                    {
                        propertyInfo.SetValue(entity, checkEdit.EditValue, EmptyTypes);
                    }
                }
                else if (control is MemoEdit)
                {
                    ...
                    if (propertyInfo != null)
                    {
                        propertyInfo.SetValue(entity, memoEdit.EditValue, EmptyTypes);
                    }
                }
                else if (control is TextEdit)
                {
                    ...
                    if (propertyInfo != null)
                    {
                        propertyInfo.SetValue(entity, textEdit.EditValue, EmptyTypes);
                    }
                }
            }
        }
            ...
            switch (fileDialog.ShowDialog())
            {
                ...
                case DialogResult.Yes:
                    try
                    {
                        ...
                        // 保存成功后运行打开保存的文件
                        if (
                            MessageBox.Show(Resources.SaveSuccessOpenIt, Resources.Notice, MessageBoxButtons.OKCancel) ==
                            DialogResult.OK)
                        {
                    ...
                    {
                        MessageBox.Show(Resources.CannotSave);
                    }
                    break;
            }
        }
        ...
        public static bool Accessable(string code)
        {
            if (_permissions == null)
            {
                ...
                // 当前用户的角色
                List<int> roleIds =
                    ServiceBloker.GetService<UserInRole>().FindAll(c => c.UserId == userId).Select(c => c.RoleId).
                                  ToList();
                if (roleIds.Count == 0) return false;

                // 当前用户的权限
                List<int> permissionIds =
                    ServiceBloker.GetService<PermissionInRole>().FindAll(c => roleIds.Contains(c.RoleId)).Select(
                ...
                _permissions =
                    ServiceBloker.GetService<Permission>().FindAll(
                        c => permissionIds.Contains(c.PermissionId) && c.Type == PermissionType.Normal);
            }
            return _permissions.Exists(c => c.Code == code);
        }

        public static LookUpEdit BindOrderType(this LookUpEdit lookUpEdit, ControlMode controlMode = ControlMode.Query)
        {
            BindOrderType(lookUpEdit.Properties, controlMode);
            return lookUpEdit;
        }

        public static RepositoryItemLookUpEdit BindOrderType(this RepositoryItemLookUpEdit lookUpEdit,
                                                             ControlMode controlMode = ControlMode.Query)
        {
            ...
            lookUpEdit.DataSource = ServiceBloker.GetEnumQuery("ProductionOrderType");
            return lookUpEdit;
        }
